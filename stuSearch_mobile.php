...
?>
<h1>Search Record</h1>
<?php require 'partials/_navsearch_mobile.php'?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
<section class="container">
    ...
    <form action="/clg_project/stuSearch_mobile.php" method="post" class="form">
        <div class="input-box">
...
<?php
        ...
        if(isset($_POST['btn1'])){
            $mobile = $_POST['mobile'];
            $sql= "SELECT * FROM `student` WHERE mobileno = '$mobile'; ";
