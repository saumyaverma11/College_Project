...
?>
<h1>Search Record</h1>
<?php require 'partials/_navsearch_course.php'?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
<section class="container">
    ...
    <form action="/clg_project/stuSearch_course.php" method="post" class="form">
...
<?php
        ...
        if(isset($_POST['btn1'])){
            $course = $_POST['course'];
            $sql= "SELECT * FROM `student` WHERE coursename = '$course'; ";
