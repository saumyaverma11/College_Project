...
?>
<h1>Search Record</h1>
<?php require 'partials/_navsearch_name.php'?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
<section class="container">
    ...
    <form action="/clg_project/stuSearch_name.php" method="post" class="form">
        <div class="column">
          <div class="input-box">
...
<?php
        ...
        if(isset($_POST['btn1'])){
            $fname = $_POST['fname'];
            $lname = $_POST['lname'];
            $sql= "SELECT * FROM `student` WHERE `first name` = '$fname' AND `last name` = '$lname'; ";
