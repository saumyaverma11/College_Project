...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    $sql = "SELECT * from `student` WHERE `student id` = '$studentid' AND `password` ='$password'";
    ...
    if($num == 1){
        ...
        header("location: signin-info.php");
    }
    else{
...
<style>
body{
    background-image: url("Images/project-login-pic.jpg");
    width: 100%;
